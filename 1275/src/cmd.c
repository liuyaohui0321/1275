...
//			{
//				memset((uint8_t *)(0xA0000000+i*4),i,4);
//			}
//			memset((uint8_t *)(0xA0002228),0x6,64);
//			AxiDma1.TxBdRing.HasDRE=1;
//			ret = XAxiDma_SimpleTransfer(&AxiDma1,(UINTPTR *)(0xA0000000),
//					8808, XAXIDMA_DMA_TO_DEVICE);
//
//			if (ret != XST_SUCCESS)
//			{
//				return XST_FAILURE;
...
//			memset((uint8_t *)(0xA0000000),0x11,7680);
//
//			memset((uint8_t *)(0xA0001E00),0x06,512);
//			AxiDma1.TxBdRing.HasDRE=1;
//			ret = XAxiDma_SimpleTransfer(&AxiDma1,(UINTPTR *)(0xA0000000),
